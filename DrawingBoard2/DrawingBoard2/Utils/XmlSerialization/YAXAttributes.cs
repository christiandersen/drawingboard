...
{
    /// <summary>
    /// The base class for all attributes defined in DrawingBoard2.Utils.
    /// </summary>
    ...
    public class YAXSerializableTypeAttribute : YAXBaseAttribute
    {
        ...
        /// <summary>
        /// Gets or sets the fields which DrawingBoard2.Utils selects for serialization
        /// </summary>
    ...
    /// <summary>
    /// Specifies a custom serializer class for a field, property, class, or struct. DrawingBoard2.Utils will instantiate an object
    ...
    /// <summary>
    /// Specifies a custom deserializer class for a field, property, class, or struct. DrawingBoard2.Utils will instantiate an object
